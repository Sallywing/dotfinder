...
prompt = {'dendrite channel: ', 'post synaptic channel', 'colocalizing channel:  ',...
    'median filter post? (1=yes, 0=no)','median kernel dimension: '};
...
Settings.ImInfo.DenCh = v.DenCh;
Settings.ImInfo.PostCh = v.PostCh;
Settings.ImInfo.ColoCh = v.ColoCh;
Settings.ImInfo.MedFilt = v. MedFilt;
Settings.ImInfo.MedFiltKern = v. MedFiltKern;

Settings.ImInfo.xNumVox = xs; %added by HO 12/16/09
Settings.ImInfo.yNumVox = ys; %added by HO 12/16/09
Settings.ImInfo.zNumVox = zs; %added by HO 12/16/09

DenCh=Settings.ImInfo.DenCh;
PostCh=Settings.ImInfo.PostCh;
ColoCh=Settings.ImInfo.ColoCh;
xyum=Settings.ImInfo.xyum;
zum=Settings.ImInfo.zum;
MedFilt=Settings.ImInfo.MedFilt;
MedFiltKern=Settings.ImInfo.MedFiltKern;

...
%        <Item name="HO iPassingSpots2ML DotsVer" icon="Matlab" tooltip="iPassingSpots2MLDotsVer. -HO">
%          <Command>Matlab::HOiPassingSpots2MLDotsVer(%i)</Command>
%        </Item>
%       </Submenu>
%      </Menu>
%      <SurpassTab>
%        <SurpassComponent name="bpSpots">
%          <Item name="HO iPassingSpots2MLDotsVer" icon="Matlab" tooltip="iPassingSpots2MLDotsVer. -HO">
%            <Command>Matlab::HOiPassingSpots2ML(%i)</Command>
%          </Item>
%        </SurpassComponent>
%        <SurpassComponent name="bpSpots">
%          <Item name="HO iPassingSpots2MLDotsVer" icon="Matlab" tooltip="iPassingSpots2MLDotsVer. -HO">
...
function HOiPassingSpots2MLDotsVer(aImarisApplicationID)
